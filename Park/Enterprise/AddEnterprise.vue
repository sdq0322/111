<template>
            ...
            <el-form ref="ruleForm" label-width="100px" :model="addForm" :rules="rules">
              ...
              <el-form-item label="所在行业" prop="industryCode">
                <el-select v-model="addForm.industryCode">
                  <el-option v-for="item in list" :key="item.industryCode" 
              ...
              <el-form-item label="营业执照" prop="businessLicenseId" >
                <!-- action是必传属性 配置的是上传文件的路径但不灵活 一般不用-->
                <!-- action即使不用，也得配置，如果没配置上传路径，需要#代替 -->
                <el-upload
                class="upload-demo"
                action="#"
              ...
              <img v-if="id" :src="addForm.businessLicenseUrl" alt="" style="width:100px">
              </el-form-item>
            </el-form>
          </div>
        </div>
  ...
  <script>
import { getIndustryListAPI,addEnterpriseAPI,getEnterpriseDetailAPI } from '@/api/enterprise'
  ...
  export default {
    ...
    methods:{
      ...
      async uploadImage({file}){
        ...
        this.$refs.ruleForm.validate('businessLicenseUrl')
